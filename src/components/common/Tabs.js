...
const Tabs = ({onBlur, onChange, state}) => {
    const {RentalIncome, ClosingCost, RehabBudget, CapExPercent, PropertyManageCostPercent, MiscOther, MiscIncome, activeTab, RepairCostPercent, CalculationData, WaterCost, Garbage, Electric, Gas, HOAFees, VacancyPercent} = state;
